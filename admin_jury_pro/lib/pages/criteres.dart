...
//import 'package:CriteresPro/ajouterEvenements.dart';
//import 'package:CriteresPro/modifierevenements.dart';
...
class Criteres extends StatefulWidget {
  @override
  _CriteresState createState() => _CriteresState();
}

class _CriteresState extends State<Criteres> {
  List criteres;
  List evenements;
  ...
  Future getCriteres() async {
    var response = await http.get("http://172.31.239.223:8000/Criteres");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Criteres Pro"),
          backgroundColor: Colors.deepOrange,
        ),
        body: criteres != null ? getDisplayDatas() : waitDatas());
  }
          ...
          child: Column(
            children: [
              ListTile(
                ...
                title: Text("${criteres[i]["Criteres_libelle"]}"),
                subtitle: Text(
