...
class _ModifierEvenementState extends State<ModifierEvenement> {
  //int id ;
  dynamic evenement;
  _ModifierEvenementState(dynamic data) {
    this.evenement = data;
    /*setState(() {
 ...
 */
  ...
  Future<Map<String, dynamic>> editEvenement(BuildContext context, String nom,
    ...
    final http.Response response = await http.post(
      'http://172.31.239.223:8000/evenements/${evenement["evenement_id"]}',
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          controller: nom..text = evenement["evenement_nom"],
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          controller: datedebut
                            ..text = evenement["evenement_date_debut"],
                          keyboardType: TextInputType.text,
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          controller: datefin
                            ..text = evenement["evenement_date_fin"],
                          keyboardType: TextInputType.text,
                          decoration:
                      ...
                      Padding(
                        padding: const EdgeInsets.only(
                            bottom: 15, left: 10, right: 10),
                        child: TextFormField(
                          controller: type..text = evenement["evenement_type"],
                          keyboardType: TextInputType.text,
